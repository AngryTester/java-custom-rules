...
public final class RulesList {
    ...
    public static List<Class<? extends JavaCheck>> getJavaChecks() {
        return Collections.unmodifiableList(Arrays.asList(
                ...
                NameShouldNotContainChineseRule.class,
                BraceChangeLineRule.class,
                BracketShouldNotLeaveSpaceRule.class,
                ReservedWordAndBracketShouldLeaveSpaceRule.class,
                ShouldNotCatchRuntimeExceptionRule.class));
    }
